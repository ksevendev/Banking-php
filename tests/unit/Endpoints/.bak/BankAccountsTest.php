...
namespace Banking\Endpoints\Test;

use Banking\Client;
use Banking\Endpoints\BankAccounts;
use Banking\Test\Endpoints\BankingTestCase;
use GuzzleHttp\Handler\MockHandler;
use GuzzleHttp\Psr7\Response;

final class BankAccountTest extends BankingTestCase
{
