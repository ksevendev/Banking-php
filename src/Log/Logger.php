...
use DateTimeZone;
use Fiber;
use Banking\Log\Handler\HandlerInterface;
use Banking\Log\Processor\ProcessorInterface;
...
class Logger implements LoggerInterface, ResettableInterface
{
    ...
    /**
     * Mapping between levels numbers defined in RFC 5424 and Banking\Log ones
     *
     ...
     * there is no performance penalty and Banking\Log 2 enabled microseconds
     ...
     * Adds a log record.
     *
     * @param  int                    $level    The logging level (a Banking\Log or RFC 5424 level)
    ...
    /**
     * Converts PSR-3 levels to Banking\Log ones if necessary
     *
     ...
     *
     * @param mixed             $level   The log level (a Banking\Log, PSR-3 or RFC 5424 level)
