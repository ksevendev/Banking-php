 ...
 *
 * Banking\Log supports the logging levels described by RFC 5424 {@see https://datatracker.ietf.org/doc/html/rfc5424}
 ...
 *
 * - Use ->getName() to get the standard Banking\Log name which is full uppercased (e.g. "DEBUG")
...
enum Level: int
{
    ...
    /**
     * Returns the Banking\Log standardized all-capitals name of the level
     *
