...
use Banking\Log\Formatter\LineFormatter;
 ...
 *
 *      $logger = new \Banking\Log\Logger('all', array(new \Banking\Log\Handler\PHPConsoleHandler()));
 *      \Banking\Log\ErrorHandler::register($logger);
 *      echo $undefinedVar;
...
class PHPConsoleHandler extends AbstractProcessingHandler
{
    ...
    private array $options = [
        ...
        'classesPartialsTraceIgnore' => ['Banking\Log\\'], // array Hide calls of classes started with...
    ...
    /**
     * @param  array<string, mixed> $options   See \Banking\Log\Handler\PHPConsoleHandler::$options for more details
