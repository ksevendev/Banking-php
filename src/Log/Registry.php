...
/**
 * Banking\Log log registry
 *
 * Allows to get `Logger` instances in the global scope
 * via static method calls on this class.
 *
 * <code>
 * $application = new Banking\Log\Logger('application');
 * $api = new Banking\Log\Logger('api');
 *
 * Banking\Log\Registry::addLogger($application);
 * Banking\Log\Registry::addLogger($api);
 *
 * function testLogger()
 * {
 *     Banking\Log\Registry::api()->error('Sent to $api Logger instance');
 *     Banking\Log\Registry::application()->error('Sent to $application Logger instance');
 * }
 * </code>
 *
